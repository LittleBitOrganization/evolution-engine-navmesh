...
namespace UnityEngine.AI
{
    ...
    public class NavMeshSurface : MonoBehaviour
    {
        ...
        [SerializeField] private List<NavMeshObject> m_roads;
        ...
        public void FindAllRoads()
        {
            ...
            List<NavMeshObject> navMeshObjects = new List<NavMeshObject>();
            foreach (var rootGameObject in rootGameObjects)
            {
                navMeshObjects.AddRange(rootGameObject.GetComponentsInChildren<NavMeshObject>(true));
            }

            m_roads = navMeshObjects;
        }
        
#if UNITY_EDITOR
        public void RoadsDisable()
        {
            foreach (var road in m_roads)
            {
                ...
                EditorUtility.SetDirty(road.GetComponent<MeshRenderer>());
            }
        }
        ...
        public void RoadsEnable()
        {
            foreach (var road in m_roads)
            {
                road.GetComponent<MeshRenderer>().enabled = true;
            }
        }

        public void AddNavMeshObject(NavMeshObject navMeshObject)
        {
            m_roads.Add(navMeshObject);
        }
